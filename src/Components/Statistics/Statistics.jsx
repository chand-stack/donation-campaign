...
<div className='flex items-center gap-3 justify-center'>
    <div>
        <p className='text-lg flex items-center'>Your Donation <AiOutlineLine className='text-[#00C49F] text-9xl font-black'></AiOutlineLine></p>
    </div>
    <div>
        <p className='text-lg flex items-center'>Total Donation <AiOutlineLine className='text-[#FF444A] text-9xl font-black'></AiOutlineLine></p>
    </div>
</div>
        </div>
    );
